...
<div class="register-photo">
	<div class="form-container" style="width: 411px; color: #000000;">
		<form:form method="POST" modelAttribute="user" action="register" style="width:796px; background-color: #a70000;">
